    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(Input.Email, "إعادة تعيين كلمة السر",
                    $"يرجى إعادة تعيين كلمة السر <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>اضغط هنا</a>.");                    
